	...
	return (
		<Router history={history}>
			<Route path="/" component={FirstPage} >
				<IndexRoute  component={OrderForm} onEnter={() => {
						//dispatch({type: 'homepage/carousel'});
						//dispatch({type: 'foodList/homeFoodList'});
						//dispatch({type: 'notification/unreadNum'});
						dispatch({type: 'cart/removeFood'});
					}
				}/>
				<Route path="OwnInfoForm" component={OwnInfoForm} />
				<Route path="FoodSecondMenu" component={FoodSecondMenu} onEnter={() => {
						dispatch({type: 'food/details'});
					}
				}/>
				...
				<Route path="DiscussForm" component={DiscussForm} onEnter={() => {
						dispatch({type: 'articleCarousel/articleCarouselUrls'});
						dispatch({type: 'articleList'});
					}
				}/>
				<Route path="TopicSecondForm" component={TopicSecondForm} onEnter={() => {
						dispatch({type: 'article/details'});
					}
				}/>
				...
				<Route path="LoginPage" component={LoginPage} onEnter={() => {
				...
				<Route path="FastLogining" component={FastLogining} onEnter={() => {
						dispatch({type: 'account/register'});
					}
				}/>
