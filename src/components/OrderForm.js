...
=======
                        iconElementLeft={<IconButton onClick={this.openInfoPage}> <div><Badge  style={{padding:'12px 24px 12px 0'}} badgeContent={4} primary={true}><NotificationsIcon />
>>>>>>> Stashed changes
                                </Badge></div>
                             </IconButton>}
